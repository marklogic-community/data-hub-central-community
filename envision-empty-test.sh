...
gradle -Dserver.port=9004 -DdhfDir=/Users/frubino/projects/empty-data-hub/datahub -DmodelsDir=/Users/frubino/projects/empty-data-hub/conceptConnectorModels -DdhfEnv=$MLENV test