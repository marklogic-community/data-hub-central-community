describe('End to end test to create and update model', () => {
	...
	it('can delete a property', () => {
		...
		cy.get('[data-cy="panel-poet"] [data-cy="entityPickList.entityPropertyName"]').should('not.contain', 'address')
		cy.get('[data-cy="panel-poet"] [data-cy="entityPickList.entityPropertyType"]').should('not.contain', 'string')
	...
	it.only('can show advanced property features', () => {
