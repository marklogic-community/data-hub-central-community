...
describe('Mastering', () => {
	...
	it('should compare unmerged items for a notification', () => {
		...
		cy.get('[data-cy="mastering.unmergeButton"]').should('not.exist')
		cy.get('[data-cy="mastering.unblockButton"]').should('not.exist')
	})
	...
	it('should compare merged items for a notification', () => {
		...
		cy.get('.delta .doc1').should('contain', 'Customer 2')
		cy.get('.delta .preview').should('contain', '["Customer 1","Customer 2"]')
		cy.get('[data-cy="mastering.mergeButton"]').should('not.exist')
		cy.get('[data-cy="mastering.blockButton"]').should('not.exist')
